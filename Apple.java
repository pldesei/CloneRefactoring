...
public class Improve {
	...
	public static String baseVersionPath = "/home/ubuntu/guavaFilter/";
	...
	public static void main(String[] args) throws Exception{
		String cloneDataPath = "/home/ubuntu/result/refactorInstances/guava/";
	...
	public static Vector<RefactoredInstance> filterWrongReference(Vector<RefactoredInstance> inses) throws Exception{
		...
		for (int i = 0; i < inses.size(); i++) {
			...
			String methodVersion = methodFrag.versionRepoID;
			...
			if (newFrags.size() == frags.size()) {
				...
				if (newFrags.size() >= 2) {
					...
					FileWriter w = new FileWriter(new File("/home/ubuntu/result/guava.txt"), true);
					w.write("Filter:" + (i+1)+"\n");
					w.close();
				}
			}
	...
	public static String getInvokePath(MyFragment frag, String version, String methodName) {
		String fragNewPath = frag.getFilePath().replace(frag.versionRepoID, version);
	...
	private static Vector<RefactoredInstance> getNewResult(Vector<RefactoredInstance> refactorInstances) throws Exception {
		...
		String refactoredOutputPath = "/home/ubuntu/result/refactorInstances/lucene/refactored1-10.txt";
