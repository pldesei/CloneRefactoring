...
public class AnotherTokenVisitor extends VoidVisitorAdapter<Void> {
	...
	public static void main(String[] args) {
		...
		try {
			in = new FileInputStream("/home/sonia/workspace/CloneAnalyzer/waterloo/FeatureExtractor.java");
		...
		for (int i : commonv.tokens.keySet()) {
			System.out.println(commonv.tokens.get(i));
		}
	}
    ...
    public void visit(FieldDeclaration n, Void arg) {
		...
		tmp.addElement(n.getType().toString());
		tokens.put(n.getBeginLine(), tmp);
        super.visit(n, arg);
    }
