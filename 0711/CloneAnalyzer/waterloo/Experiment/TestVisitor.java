...
public class TestVisitor extends VoidVisitorAdapter<Void> {
	...
	public HashMap<Integer, Vector<String>> uses = new HashMap<Integer, Vector<String>>();
	public HashMap<Integer, Vector<String>> declares = new HashMap<Integer, Vector<String>>();
	int start;
	int end;
	int parameter;
	
	public static void main(String[] args) throws Exception {
		CompilationUnit cu = JavaParser.parse(new File("/Users/Sonia/test.java"));
		TestVisitor v = new TestVisitor(15, 61);
		v.visit(cu, null);
	...
	public TestVisitor(int start, int end) {
		this.start = start;
		this.end = end;
	}
	
	public int getNotLocalVarieables() {
		HashSet<String> use = new HashSet<String>();
		HashSet<String> declare = new HashSet<String>();
		for (int i = start; i <= end; i++) {
			Vector<String> tmp = uses.get(i);
		...
		return use.size()-declare.size()-parameter;
	}
    ...
    public void visit(MethodDeclaration n, Void arg) {
		if (start <= n.getBeginLine() && n.getEndLine() <= end) {
			if (n.getParameters() == null)
				...
				this.parameter = n.getParameters().size();
		}
		int startLine = n.getBeginLine();
		Vector<String> tmp = new Vector<String>();
		if (tokens.containsKey(startLine)) {
    ...
    public void visit(NameExpr n, Void arg) {
		...
		if (uses.containsKey(startLine)) {
			tmp2 = uses.get(startLine);
		}
		tmp2.addElement(n.getName());
		uses.put(startLine, tmp2);
        super.visit(n, arg);
    }
    ...
    public void visit(VariableDeclarator n, Void arg) {
		...
		Vector<String> tmp2 = new Vector<String>();
		if (declares.containsKey(startLine)) {
			tmp2 = declares.get(startLine);
		}
		String str = n.toString().replace(" ", "");
		if (str.indexOf("=") > 0)
			str = str.substring(0, str.indexOf("="));
		tmp2.addElement(str);
		declares.put(startLine, tmp2);
